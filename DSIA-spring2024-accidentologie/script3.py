...
# Ajouter 'agg' à la liste top_features grâce à l'analyse de la matrice de corr
top_features.append('agg')
top_features.append('plan')
...
rf_model_top = RandomForestClassifier(n_estimators=200, random_state=50)

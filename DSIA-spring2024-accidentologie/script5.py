...
#feature engineering
bdd_train['age'] = 2019 - bdd_train['an_nais']
bdd_test['age'] = 2019 - bdd_test['an_nais']
...
top_features =['lat', 'long', 'secu2', 'dep', 'hour', 'minute', 'age', 'jour', 'mois', 'Num_Acc', 'agg', 'plan']
#top_features = ['lat','long', 'secu2', 'dep', 'hrmn', 'an_nais', 'jour', 'loc', 'mois', 'Num_Acc','agg','plan']
...
rf_model_top = RandomForestClassifier(n_estimators=100, random_state=50)
...
print(accuracy_top, roc_auc_top)
